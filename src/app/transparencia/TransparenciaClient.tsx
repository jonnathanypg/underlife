...
const content = {
  es: {
    ...
    legalItems: [
      ...
      { label: 'RUC', value: '0993093904001' },
      { label: 'Aprobación Ministerial', value: 'Resolución Administrativa N° MIES-CZ-5-DDM-2018-0036-R (MIES Ecuador)' },
      { label: 'Registro de Directiva', value: 'Oficio N° MDH-CZ-5-DDM-2025-0587-OF (Período 2024–2028)' },
      { label: 'Representación Legal', value: 'Jonnathan Yosue Peña Guachun (Presidente)' },
      { label: 'Tipo de Entidad', value: 'Organización sin fines de lucro (ONG privada)' },
      { label: 'País de Constitución', value: 'Ecuador' },
      { label: 'Año de Fundación', value: '2018' },
      { label: 'Domicilio Legal', value: 'Cantón Milagro, Provincia del Guayas, Ecuador' },
      { label: 'Email Institucional', value: 'info@fundacionunderlife.org' },
      { label: 'Teléfono de Contacto', value: '+593 986 020 391' },
      { label: 'Sitio Web Oficial', value: 'https://fundacionunderlife.org' },
    ],
    missionTitle: 'Misión',
    mission:
  ...
  en: {
    ...
    legalItems: [
      ...
      { label: 'Tax ID (RUC)', value: '0993093904001' },
      { label: 'Ministerial Approval', value: 'Administrative Resolution N° MIES-CZ-5-DDM-2018-0036-R (MIES Ecuador)' },
      { label: 'Executive Board Registry', value: 'Official Notice N° MDH-CZ-5-DDM-2025-0587-OF (2024–2028)' },
      { label: 'Legal Representation', value: 'Jonnathan Yosue Peña Guachun (President)' },
      { label: 'Entity Type', value: 'Non-profit organization (Private NGO)' },
      { label: 'Country of Incorporation', value: 'Ecuador' },
      { label: 'Year Founded', value: '2018' },
      { label: 'Legal Address', value: 'Milagro, Guayas, Ecuador' },
      { label: 'Official Email', value: 'info@fundacionunderlife.org' },
      { label: 'Phone', value: '+593 986 020 391' },
      { label: 'Official Website', value: 'https://fundacionunderlife.org' },
    ],
  ...
  pt: {
    ...
    legalItems: [
      ...
      { label: 'CNPJ/RUC', value: '0993093904001' },
      { label: 'Aprovação Ministerial', value: 'Resolução Administrativa N° MIES-CZ-5-DDM-2018-0036-R (MIES Equador)' },
      { label: 'Registro de Diretoria', value: 'Ofício N° MDH-CZ-5-DDM-2025-0587-OF (2024–2028)' },
      { label: 'Representação Legal', value: 'Jonnathan Yosue Peña Guachun (Presidente)' },
      { label: 'Tipo de Entidade', value: 'Organização sem fins lucrativos (ONG privada)' },
      { label: 'País de Constituição', value: 'Equador' },
      { label: 'Ano de Fundação', value: '2018' },
      { label: 'Endereço Legal', value: 'Milagro, Guayas, Equador' },
      { label: 'E-mail Oficial', value: 'info@fundacionunderlife.org' },
      { label: 'Telefone', value: '+593 986 020 391' },
      { label: 'Site Oficial', value: 'https://fundacionunderlife.org' },
    ],
    missionTitle: 'Missão',
    mission:
