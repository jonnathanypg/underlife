...
export default function PrivacyCookieBanner() {
  ...
  const content = {
    es: {
      ...
      desc: 'En Fundación Underlife valoramos tu privacidad. Empleamos cookies técnicas necesarias para asegurar el funcionamiento seguro, la autenticación y la experiencia en nuestra plataforma. Tus datos jamás son comercializados con terceros.',
    ...
    en: {
      ...
      desc: 'At Fundación Underlife, we protect your privacy. We use essential technical cookies to ensure platform security, smooth navigation, and system integrity. Your data is never sold to third parties.',
    ...
    pt: {
      ...
      desc: 'Na Fundación Underlife, valorizamos sua privacidade. Utilizamos cookies técnicos indispensáveis para garantir a segurança e a navegação fluida em nossa plataforma. Seus dados nunca são comercializados com terceiros.',
    ...
    >
      <div
        style={{
          ...
          boxShadow: '0 20px 48px -10px rgba(0, 10, 40, 0.35)',
